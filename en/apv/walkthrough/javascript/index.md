...
on other websites. Such dialog can be displayed using a [JavaScript](/en/apv/articles/javascript) code and it
...
[Similarly to CSS](/en/apv/walkthrough/css/#linking-your-css-to-html-file), a JavaScript file is usually referenced in the `<head>`
...
The basic JavaScript syntax is described in a separate [article](/en/apv/articles/javascript/#javascript-basics).
...
to *attach some [event handlers](/en/apv/articles/javascript/#javascript-events)* ---   execute a piece of code after a visitor
...
attribute, `document` is a global object which contains the [tree structure](/en/apv/articles/html/#hierarchical-structure) of your HTML elements.
...
element. You may remember about [user defined attributes](/en/apv/articles/html/#data-attributes) which can be accessed
...
Basic [event registration](/en/apv/articles/javascript/#javascript-events) can be performed in the same manner
...
{% highlight html %}
{% include /en/apv/walkthrough/javascript/creating-elements.html %}
{% endhighlight %}
...
In the chapter about [records deletion](/en/apv/walkthrough/backend-delete), you were referred to this article for
...
{% highlight html %}
{% include /en/apv/walkthrough/javascript/prevent-nav-form-parameters-1.html %}
{% endhighlight %}
...
{: .solution}
{% highlight html %}
{% include /en/apv/walkthrough/javascript/prevent-nav-form-parameters-2.html %}
{% endhighlight %}
...
Now enhance the [script for deleting persons](/en/apv/walkthrough/backend-delete). Insert a piece of
...
{: .solution}
{% highlight html %}
{% include /en/apv/walkthrough/javascript/templates/delete.latte %}
{% endhighlight %}
...
You can adjust CSS styles using `:valid`, `:invalid` or `:required` [pseudo-classes](/en/apv/walkthrough/css/#pseudoclasses)
...
[AJAX](/en/apv/articles/javascript#ajax).
