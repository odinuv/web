...
In the previous chapter I have explained the [CSS](/en/apv/walkthrough/css/) basics. You should know that CSS is a language which
...
HTML element. Do not confuse this with a space in a [CSS selector](/en/apv/articles/css/#combining-selectors).
...
Although it is very complicated, Bootstrap is nothing more than CSS. So [all of the CSS rules](/en/apv/articles/css/#inheritance--cascading)
...
of the device using a [**media query**](/en/apv/articles/css/#at-rules).
