...
In the [previous article](/en/apv/articles/database-systems/), I have described different types of
...
[row-oriented databases](/en/apv/articles/database-systems/#storage) (but
...
infinitely complex too. There is a another whole [article article about data modelling](/en/apv/articles/database-design/), but
...
[**sequence**](/en/apv/articles/database-tech/#automatically-generated-key)
...
in a [separate article about inserting](/en/apv/walkthrough/backend-insert/advanced/).
...
[article about database design](/en/apv/articles/database-design/#using-e-r-model)).
