...
Each database type may use different technologies, but the [SQL language](/en/apv/articles/sql-join/) or something similar to it is used
...
I will deal with the SQL language in more detail in the [next article](/en/apv/articles/sql-join/).
