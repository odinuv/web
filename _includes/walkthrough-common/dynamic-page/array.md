...
{% highlight php %}
{% include /walkthrough-common/dynamic-page/array-1.php %}
{% endhighlight %}
...
{% highlight php %}
{% include /walkthrough-common/dynamic-page/array-1a.php %}
{% endhighlight %}
...
{% highlight php %}
{% include /walkthrough-common/dynamic-page/array-2.php %}
{% endhighlight %}

An alternative definition -- item by item:

{% highlight php %}
{% include /walkthrough-common/dynamic-page/array-2a.php %}
{% endhighlight %}

An alternative longer syntax:

{% highlight php %}
{% include /walkthrough-common/dynamic-page/array-2b.php %}
{% endhighlight %}
...
{% highlight php %}
{% include /walkthrough-common/dynamic-page/array-2c.php %}
{% endhighlight %}
...
{% highlight php %}
{% include /walkthrough-common/dynamic-page/array-3.php %}
{% endhighlight %}

Defined all in one go:

{% highlight php %}
{% include /walkthrough-common/dynamic-page/array-3a.php %}
{% endhighlight %}
...
{% highlight php %}
{% include /walkthrough-common/dynamic-page/array-4.php %}
{% endhighlight %}
...
{% highlight php %}
{% include /walkthrough-common/dynamic-page/array-8.php %}
{% endhighlight %}
...
{% highlight php %}
{% include /walkthrough-common/dynamic-page/array-6.php %}
{% endhighlight %}
...
{% highlight php %}
{% include /walkthrough-common/dynamic-page/array-7.php %}
{% endhighlight %}
...
{% highlight php %}
{% include /walkthrough-common/dynamic-page/array-7a.php %}
{% endhighlight %}
...
{% highlight php %}
{% include /walkthrough-common/dynamic-page/array-7b.php %}
{% endhighlight %}
...
![Screenshot -- Array of Flintstones](/en/apv/walkthrough-common/dynamic-page/array-sol-1.png)

{: .solution}
{% highlight php %}
{% include /walkthrough-common/dynamic-page/array-sol-1.php %}
{% endhighlight %}
...
![Screenshot -- Form for logged user](/en/apv/walkthrough-common/dynamic-page/form-5a.png)

This is how the form should look like for an unknown user:

![Screenshot -- Form for logged user](/en/apv/walkthrough-common/dynamic-page/form-5b.png)
...
{: .solution}
{% highlight php %}
{% include /walkthrough-common/dynamic-page/form-5.php %}
{% endhighlight %}
