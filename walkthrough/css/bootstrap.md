...
In the previous chapter I have explained the [CSS](/walkthrough/css/) basics. You should know that CSS is a language which
...
directory structure. If you want to use Bootstrap's [JavaScript](/walkthrough/javascript/) features, you should also link
...
{% highlight html %}
{% include /walkthrough/css/head-skeleton.html %}
{% endhighlight %}
...
{% highlight html %}
{% include /walkthrough/css/bootstrap-table.html %}
{% endhighlight %}
...
![Screenshot - Overridden button colors](/walkthrough/css/button-override.png)
...
{: .solution}
{% highlight html %}
{% include /walkthrough/css/bootstrap-override.html %}
{% endhighlight %}
...
{: .solution}
{% highlight css %}
{% include /walkthrough/css/my-styles.css %}
{% endhighlight %}
...
{% highlight css %}
{% include /walkthrough/css/media-queries.css %}
{% endhighlight %}
...
{% highlight html %}
{% include /walkthrough/css/media-queries.html %}
{% endhighlight %}
...
{% highlight html %}
{% include /walkthrough/css/bootstrap-responsive.html %}
{% endhighlight %}
