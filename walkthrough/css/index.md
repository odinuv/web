...
[write a HTML page](/walkthrough/html/) and also how to
[use the Latte templating system](/walkthrough/templates/).
...
{: .image-popup}
![Screenshot -- Applied CSS](/walkthrough/css/example-01.png)
...
![Screenshot -- Cascading](/walkthrough/css/cascading.png)
...
{: .image-popup}
![HTML tree](/walkthrough/css/html.svg)
...
{: .solution}
{% highlight html %}
{% include /walkthrough/css/round-corners.html %}
{% endhighlight %}
...
{: .solution}
{% highlight html %}
{% include /walkthrough/css/relative-absolute.html %}
{% endhighlight %}
...
![Box model](/walkthrough/css/box-model.svg)
...
In the [following chapter](/walkthrough/css/bootstrap) I will show you how to use some freely available CSS styles
